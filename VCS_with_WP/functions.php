...
add_image_size('logo', 131, 37);
add_image_size('pc_pic',450, 330);
add_image_size('rw_pic',215, 200, crop);
...
function theme_stylesheets(){
	...
	if( $styles_path ) {
		...
		wp_register_style('all', 'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css',
...
$sidebars = array( 'Easy Twitter Feed Widget','Easy Twitter Feed Widget2', 'flickr','Blog Widgets' );
